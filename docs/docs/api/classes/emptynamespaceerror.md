...
*Defined in [packages/redux-data-model/src/errors.ts:28](https://github.com/kayak/redux-data-model/blob/11ed706/packages/redux-data-model/src/errors.ts#L28)*
